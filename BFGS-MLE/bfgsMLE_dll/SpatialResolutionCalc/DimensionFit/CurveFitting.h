...
void DimFit_LineOrder1_PreFitting(float *FitPara, float *ix, float *iy, int DataNum);

float DimFit_LineOrder1_TargerF(float *FitPara, float *ix, float *iy, int DataNum);
