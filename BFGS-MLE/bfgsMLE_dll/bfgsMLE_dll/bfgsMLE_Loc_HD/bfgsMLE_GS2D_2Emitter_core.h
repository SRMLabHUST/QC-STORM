...
__global__ void bfgsMLELoc_Gauss2D_2E(float *d_LocArry, unsigned short *d_ImageROI, float *d_WLEPara, int MultiFitFluoNum, int * d_MultiFitFluoPos, float Offset, float kadc, float QE)
{
...
#pragma unroll
	...
	if (gid < MultiFitFluoNum)
	{
		...
		//		printf("ininf: %d-%d %d %d, %f %f %f %f %f %f %f %f\n", gid, XOffset, YOffset, CurFrame, Ininf[0][tid], Ininf[1][tid], Ininf[2][tid], Ininf[3][tid], Ininf[4][tid], Ininf[5][tid], Ininf[6][tid], Ininf[7][tid]);
