#ifndef __SUSREGION_EXTRACTION_LD_H
#define __SUSREGION_EXTRACTION_LD_H
...
#define MaxGroupImgSize			Size32MB
...
// enable extract several images, the image memory must be continuously stored in the pImgData
// and max image size is MaxGroupImgSize
// this will be very high efficient for small images, since copy of small image from CPU to GPU is time consuming
...
#endif // __SUSREGION_EXTRACTION_LD_H
