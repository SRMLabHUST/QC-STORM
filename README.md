...
7, If the plugin cannot run, please make sure: 1, the compute capability of the gpu is no less than 3.5; 2, your GPU is detected by the operation system; 3, please update the GPU driver to the newest (Compatible Driver Versions >= 411.31).
